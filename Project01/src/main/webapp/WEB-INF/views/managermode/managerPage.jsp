...
<head>
    ...
    <link href="/board/css/sb-admin-2.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/board/managermode/managerPage">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${mb.m_id}님</span>&nbsp;
                                <img class="img-profile rounded-circle"
                                    src="/board/img/blank-profile-picture-973460_1280.png">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="/board/home/welcome">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">정말로 로그아웃 하시겠습까?</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="/board/home/logout">Logout</a>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function(){
    $.ajax({
         type:'get',
         url:'/board/managermode/movieManagement',
         dataType: 'html',
...
$("#movieManagement").click(function(){
	...
	$("#memberManagement").click(function(){
	  $.ajax({
	      type:'get',
	      url:'/board/managermode/memberManagement',
	      dataType: 'html',
	      success: function(data){
	         $("#main-text").html(data);
	      },
