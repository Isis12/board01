...
public class HomeController {
	...
	@RequestMapping(value = "/managermode/contentModification", method = RequestMethod.GET)
	public ModelAndView contentModification(int MO_NUM) {
		mav= me.movieModify(MO_NUM);
		return mav;
	}
